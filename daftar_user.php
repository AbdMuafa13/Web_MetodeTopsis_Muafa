...
<?php 
	...
	if(isset($_POST["hapus_user"])){
		...
		$sql_delete = "DELETE FROM `user` WHERE `id` = :id_hapus_user";
				    ...
				    <li>
						...
						<div class="card">
								<div class="card-content">
									<center><h4 style="margin-bottom: 0px; margin-top: -8px;">Daftar User</h4></center>
									<table id="table_id" class="hover dataTablesCustom" style="width:100%">
											...
											<tbody>
												<?php
												$query=mysqli_query($selectdb,"SELECT * FROM user");
												$no=1;
												...
												<tr>
													...
													<td>
														<center>
															<form method="POST">
																<input type="hidden" name="id_hapus_user" value="<?php echo $data['id'] ?>">
                                                    ...
                                                    <td>
														<center>
																...
																<a href="edituser.php?id=<?php echo $data['id']; ?>"><button  type="submit" style="height: 32px; width: 32px;" class="btn-floating btn-small waves-effect waves-light green"><i style="line-height: 32px;" class="material-icons">edit</i></button></a>
	...
	<div id="tambah" class="modal" style="width: 40%; height: 100%;">
		<div class="modal-content">
			<div class="col s6">
					<div class="card-content">
						<div class="row">
							<center><h5 style="margin-top:-8px;">Masukan Data</h5></center>
