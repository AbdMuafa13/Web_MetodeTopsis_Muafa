...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 20, 2022 at 06:08 AM
...
-- Database: `data_hp`
--
CREATE DATABASE IF NOT EXISTS `data_hp` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `data_hp`;
...
CREATE TABLE IF NOT EXISTS `data_hp` (
  `id_hp` int(4) NOT NULL AUTO_INCREMENT,
  ...
  `jenis` varchar(32) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`id_hp`)
...
INSERT INTO `data_hp` (`id_hp`, `nama_hp`, `harga_hp`, `ram_hp`, `memori_hp`, `processor_hp`, `kamera_hp`, `harga_angka`, `ram_angka`, `memori_angka`, `processor_angka`, `kamera_angka`, `jenis`) VALUES
(1, 'Oppo Neo 7', '1700000', '1', '16', 'Quadcore', '8', '4', '1', '3', '3', '3', 'gaming'),
(2, 'Mito A880', '550000\r\n', '1', '8', 'Quadcore', '5', '5', '1', '2', '3', '1', 'biasa'),
(4, 'Oppo A83', '1899000', '3', '32', 'Octacore', '13', '4', '3', '4', '4', '3', 'biasa'),
(5, 'Honor 8x', '3649000\r\n', '4', '128', 'Octacore', '20', '3', '4', '5', '5', '5', 'biasa'),
(6, 'Sony Xperia Z1', '1250000', '3', '32', 'Quadcore', '20.7', '4', '3', '4', '3', '5', 'biasa'),
...
(11, 'Realme 2 Pro', '2949000', '4', '64', 'Octacore', '16', '4', '4', '5', '5', '5', 'biasa'),
